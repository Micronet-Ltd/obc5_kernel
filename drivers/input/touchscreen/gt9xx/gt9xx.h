...
#define GTP_ERROR(fmt,arg...)   printk("GTP")
#define GTP_INFO(fmt,arg...)    printk("GTP")
#define GTP_DEBUG(fmt,arg...)    printk("GTP")
#define GTP_DEBUG_ARRAY(fmt,arg...)    printk("GTP")
#define GTP_DEBUG_FUNC(fmt,arg...)    printk("GTP")
