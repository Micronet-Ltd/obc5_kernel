...
/*add by shengweiguang for poll delay 20150608 begin */
...
/* add by shengweiguang begin 20150608 */
	tj9->poll_dev->poll_interval=delay_msec;
/* add by shengweiguang end 20150608 */
...
static int kxtj9_verify(struct kxtj9_data *tj9)
{
	...
	pr_info("shengweiguang : retval : 0x%x !!!\n", retval);
...
dev_err(&client->dev, "shengweiguang 11111111111111\n");
	pr_info("shengweiguang 11111111111\n");
	...
	if (client->irq) {
		pr_info("shengweigang : KXJT9 IRQ mode !!!!!!!\n");
		...
		pr_info("shengweigang : KXJT9 POLL mode !!!!!!!\n");
