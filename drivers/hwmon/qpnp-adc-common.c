...
// by skj
static const struct qpnp_vadc_map_pt adcmap_qrd_smb135x_btm_threshold[] = {
	{-1000,	1800},
	{-200,	1634},
	{0,		1379},
	{30,	1337},
...
// by skj
static const struct qpnp_vadc_map_pt adcmap_a8_btm_threshold[] = {
	{-1000,	1800},
	{-100,	1479},
	{-50,	1419},
	{0,		1349},
...
// by skj
int32_t qpnp_adc_scale_smb135x_batt_therm(struct qpnp_vadc_chip *chip,
		int32_t adc_code,
		const struct qpnp_adc_properties *adc_properties,
		const struct qpnp_vadc_chan_properties *chan_properties,
		struct qpnp_vadc_result *adc_chan_result)
{
	...
	bat_voltage = qpnp_adc_scale_ratiometric_calib(adc_code,
			adc_properties, chan_properties);
	// printk("skj qpnp_adc_scale_smb135x_batt_therm ntc %d\n",(int)bat_voltage);
	return qpnp_adc_map_temp_voltage(
			adcmap_qrd_smb135x_btm_threshold,
			ARRAY_SIZE(adcmap_qrd_smb135x_btm_threshold),
			bat_voltage,
			&adc_chan_result->physical);
}

int32_t qpnp_adc_scale_a8_batt_therm(struct qpnp_vadc_chip *chip,
		int32_t adc_code,
		const struct qpnp_adc_properties *adc_properties,
		const struct qpnp_vadc_chan_properties *chan_properties,
		struct qpnp_vadc_result *adc_chan_result)
{
	...
	bat_voltage = qpnp_adc_scale_ratiometric_calib(adc_code,
			adc_properties, chan_properties);
	//printk("skj qpnp_adc_scale_a8_batt_therm ntc %d\n",(int)bat_voltage);
	return qpnp_adc_map_temp_voltage(
			adcmap_a8_btm_threshold,
			ARRAY_SIZE(adcmap_a8_btm_threshold),
			bat_voltage,
			&adc_chan_result->physical);
}
