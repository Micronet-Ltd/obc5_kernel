...
extern int qrt_mdm_usb_mng_enable; // add by shengweiguang for J20 and J20TMP mdm
...
static void ci13xxx_msm_notify_event(struct ci13xxx *udc, unsigned event)
{
	...
	/* add by shengweiguang for J20 mdm begin */
		if (0 != qrt_mdm_usb_mng_enable)
		{
			pr_info("shengweiguang CCCCCCCCCCC!!!!\n");
		}
